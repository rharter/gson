...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
  ...
  public ReflectiveTypeAdapterFactory(ConstructorConstructor constructorConstructor,
      NamingStrategy namingStrategy, FieldNamingStrategy fieldNamingPolicy, Excluder excluder) {
  ...
  /** first element holds the default name */
  static List<String> getFieldName(NamingStrategy namingStrategy,
      FieldNamingStrategy fieldNamingPolicy, Field f) {
    SerializedName serializedName = f.getAnnotation(SerializedName.class);
    List<String> fieldNames = new LinkedList<String>();
    if (serializedName == null) {
      fieldNames.add(fieldNamingPolicy != null ? fieldNamingPolicy.translateName(f) :
